        ...
        <form name="" action="">
            <table>
                <tr>
                    ...
                    <td><input type="button" value="Press" onclick="javascript:doAjaxAction('loadOffices', this);"></td>
                </tr>
                <tr>
                    <td>Select an office :</td>
                    <td>
                        <select id="offices" name="officeId" onchange="javascript:doAjaxAction('officeSelection', this);">
                            <option>--- ---</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="employees" name="matriculationCode" onchange="javascript:doAjaxAction('employeeSelection', this);">
                            <option>--- ---</option>
                        </select>
                    </td>
                </tr>
