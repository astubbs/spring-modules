...
package org.springmodules.samples.jrules.services;
...
import org.springmodules.samples.jrules.daos.CarsDAO;
...
public class CarsServiceImpl implements CarsService {
	...
	private void afficherListCars(List cars) {
	...
	public void testStateless() {
		...
		/*List carsGoodBargain=(List)*/getTemplate().executeStateless("cars",null,new StatelessRuleSessionCallback() {
		...
		//afficherListCars(carsGoodBargain);
		afficherListCars(cars);
	}

	public void testStateful() {
		final List cars=carsDAO.getCars();
		List carsGoodBargain=(List)getTemplate().executeStateful(CARS_RULE_URI,null,new StatefulRuleSessionCallback() {
