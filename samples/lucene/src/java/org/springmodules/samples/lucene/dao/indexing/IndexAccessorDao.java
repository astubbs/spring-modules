 ...
 */
public interface IndexAccessorDao {
	IndexInformations getIndexInformations();
	void addDocument(String id, String title, String text, String category);
	void addDocument(FileDocumentHolder holder);
	void purgeIndex();
}