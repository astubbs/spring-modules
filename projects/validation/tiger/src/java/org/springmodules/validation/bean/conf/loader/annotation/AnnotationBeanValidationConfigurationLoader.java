...
public class AnnotationBeanValidationConfigurationLoader implements BeanValidationConfigurationLoader,
    ...
    /**
     * Determines whether the given annotation is a validation annotation or not.
     *
     * @param annotation The annotation to inspect.
     * @return <code>true</code> if the given annotation is a validation annotation, <code>false</code> otherwise.
     */
