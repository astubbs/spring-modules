...
/*
* $Header: /cvs/springmodules/projects/validation/src/java/org/springmodules/validation/commons/validwhen/ValidWhenParser.java,v 1.2 2006/06/05 19:51:14 hueboness Exp $
* $Revision: 1.2 $
...
public ValidWhenParser(ParserSharedInputState state) {
  ...
  tokenNames = _tokenNames;
	...
	public final void field() throws RecognitionException, TokenStreamException {
		...
		else if ((LA(1)==IDENTIFIER) && (LA(2)==LBRACKET) && (LA(3)==DECIMAL_LITERAL||LA(3)==HEX_LITERAL) && (LA(4)==RBRACKET) && (LA(5)==IDENTIFIER)) {
			identifier();
			match(LBRACKET);
			number();
			match(RBRACKET);
		...
		else if ((LA(1)==IDENTIFIER) && (LA(2)==LBRACKET) && (LA(3)==DECIMAL_LITERAL||LA(3)==HEX_LITERAL) && (LA(4)==RBRACKET) && (LA(5)==LBRACKET)) {
			identifier();
			match(LBRACKET);
			number();
			match(RBRACKET);
