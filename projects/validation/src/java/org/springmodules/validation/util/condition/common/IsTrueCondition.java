 ...
 * @author Uri Boness
 */
public class IsTrueCondition extends NonNullAcceptingTypeSpecificCondition {
    ...
    /**
     * Checks whether the given boolean object is <code>true</code>.
     *
     * @param bool The boolean object to be checked.
