...
/**
 * <p>
 * Unit Tests for <code>{@link CoherenceFlushingModel}</code>.
 * </p>
 * 
 * @author Alex Ruiz
 */
public class CoherenceFlushingModelTests extends AbstractEqualsHashCodeTestCase {

  private CoherenceFlushingModel model;

  public CoherenceFlushingModelTests(String name) {
    super(name);
  }
  ...
  public void testEqualsHashCodeRelationship() {
    ...
    CoherenceFlushingModel model2 = new CoherenceFlushingModel(cacheNames);
  ...
  public void testEqualsIsConsistent() {
    ...
    CoherenceFlushingModel model2 = new CoherenceFlushingModel(csvCacheNames);
  ...
  public void testEqualsIsSymmetric() {
    ...
    CoherenceFlushingModel model2 = new CoherenceFlushingModel();
    model2.setFlushBeforeMethodExecution(flushBeforeMethodExecution);
  ...
  public void testEqualsIsTransitive() {
    ...
    model.setCacheNames(cacheNames);
    CoherenceFlushingModel model2 = new CoherenceFlushingModel(cacheNames);
    CoherenceFlushingModel model3 = new CoherenceFlushingModel(cacheNames);
  ...
  protected void setUp() {
    model = new CoherenceFlushingModel();
  }
}
