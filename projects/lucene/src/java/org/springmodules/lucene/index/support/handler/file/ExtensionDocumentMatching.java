...
public class ExtensionDocumentMatching implements DocumentMatching {
	...
	/**
	 * Construct a new ExtensionDocumentMatching with the extension
	 * to match.
	 */
	public ExtensionDocumentMatching(String extension) {
	...
	public boolean match(String name) {
		int index=-1;
		if( (index=name.lastIndexOf(EXTENSION_SEPARATOR))!=-1 ) {
