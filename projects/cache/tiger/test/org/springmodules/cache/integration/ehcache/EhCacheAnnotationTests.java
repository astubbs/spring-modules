...
import org.springmodules.cache.integration.ehcache.AbstractEhCacheTests;
 ...
 * @author Alex Ruiz
 */
public class EhCacheAnnotationTests extends AbstractEhCacheTests {
  ...
  protected final String[] getConfigFileNames() {
    return new String[] { CACHE_CONFIG, "ehCacheAnnotationContext.xml" };
  }
}