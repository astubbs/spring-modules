...
/**
 * <p>
 * Unit Tests for <code>{@link GigaSpacesModelValidator}</code>.
 * </p>
 *
 * @author Alex Ruiz
 */
public final class GigaSpacesModelValidatorTests extends TestCase {

  private GigaSpacesCachingModel cachingModel;

  private GigaSpacesFlushingModel flushingModel;

  private GigaSpacesModelValidator validator;

  public GigaSpacesModelValidatorTests(String name) {
    super(name);
  }
  ...
  protected void setUp() {
    cachingModel = new GigaSpacesCachingModel();
    flushingModel = new GigaSpacesFlushingModel();
    validator = new GigaSpacesModelValidator();
  }
