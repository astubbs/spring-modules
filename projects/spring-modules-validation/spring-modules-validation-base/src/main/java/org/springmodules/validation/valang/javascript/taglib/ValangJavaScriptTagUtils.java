...
/**
 * Static helper methods that place a <code>ValangValidator</code> into a model so that is is accessible to the JSP
 * custom tag {@link ValangValidateTag}.
 * 
