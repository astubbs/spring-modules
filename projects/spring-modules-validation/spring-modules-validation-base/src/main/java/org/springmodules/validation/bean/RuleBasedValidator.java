...
/**
 * A {@link org.springframework.validation.Validator} implementation which uses
 * {@link org.springmodules.validation.bean.rule.ValidationRule}'s to define its validation execution. There are two
 * types of validation rules this validator accepts:
 * <ul>
 * <li>
 * Global Rules - Rules that apply on the validated objects and where all validation errors are registered globaly with
 * the {@link Errors} object (i.e. {@link Errors#reject(String)}).</li>
 * <li>
 * Property Rules - Rules that apply on specific properties of the validated objects and where all validation errors are
 * registered with the {@link Errors} object under the context of those properties (i.e.
 * {@link Errors#rejectValue(String, String)}).</li>
 * </ul>
 * 
 * @author Uri Boness
 */
public class RuleBasedValidator implements Validator {
    ...
    public void setGlobalRules(List globalRules) {
        this.globalRules = globalRules;
    }

    public Map getRulesByProperty() {
        return rulesByProperty;
    }

    public void setRulesByProperty(Map rulesByProperty) {
        this.rulesByProperty = rulesByProperty;
    }
    ...
    /**
     * Contrusts a new RuleBasedValidator for the given type. After contruction, this validator will initially hold no
     * rules.
     */
    ...
    /**
     * This validator supports all classes. Any object can be validated by this validator as long as the validation
     * rules apply to it.
     * 
     ...
     * 
     * @param globalRules
     *            The extra global validation rules to be added to this validator.
     */
     ...
     * 
     * @param propertyName
     *            The name of the property the added rule is associated with.
     * @param fieldValueCondition
     *            The condition of the rule.
     * @param errorCode
     *            The error code of the rule.
     */
     ...
     *            The error code of the rule.
     * @param args
     *            The arguments of the error code of the rule.
     ...
     *            The error code of the rule.
     * @param message
     *            The default error message of the rule.
     * @param args
     *            The arguments of the error code of the rule.
     * @see #addPropertyRule(String, org.springmodules.validation.util.condition.Condition, String, Object[])
     */
     ...
     * 
     * @param propertyName
     *            The name of the property associated with the added rule.
     * @param propertyRule
     ...
     * evaluated on the validated object, not on the property value. The only difference between this added rule and a
     * global rule is that the validation errors of this rule are associated with the given property and are not
     * associated globaly with the validated object.
     * <p/>
     * This type of rule comes in handy when a complex validation is required on the validation object, but the error is
     * should only be associated with a specific property. An example would be when two properties of the validated
     * object should match (i.e. have the same value), but if they don't, the error will only be associated with one of
     * them (e.g. when a UserRegistration object holds a password and confirmPassword properties - this should generally
     * match, but if they don't, the error will only be associated with the confirmPassword property).
     * 
     * @param propertyName
     *            The name of the property to associated with the added rule.
     * @param globalRule
     *            The global rule to be added.
     */
     ...
     * all validation error of this rule will be registered with the {@link Errors} object globaly (see
     * {@link Errors#reject(String)}).
     * 
     * @param condition
     *            The condition of the added rule.
     * @param errorCode
     *            The error code of the added rule.
     */
     ...
     *            The error code of the added rule.
     * @param args
     *            The arguments for the error of the added rule.
     ...
     *            The error code of the added rule.
     * @param message
     *            The error message of the added rule.
     * @param args
     *            The arguments for the error of the added rule.
     * @see #addGlobalRule(org.springmodules.validation.util.condition.Condition, String)
     */
     ...
     *            The error code of the added rule.
     * @param message
     *            The default error message of the added rule.
     * @see #addGlobalRule(org.springmodules.validation.util.condition.Condition, String)
     */
