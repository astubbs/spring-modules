...
/**
 * Tests for {@link BetweenIncludingUpperBoundCondition}.
 *
 * @author Uri Boness
 */
public class BetweenIncludingUpperBoundConditionTests extends AbstractBetweenConditionTests {

    protected AbstractBetweenCondition createBetweenCondition(Comparable lowerBound, Comparable upperBound) {
        return new BetweenIncludingUpperBoundCondition(lowerBound, upperBound);
    }

    protected AbstractBetweenCondition createBetweenCondition(Object lowerBound, Object upperBound, Comparator comparator) {
        return new BetweenIncludingUpperBoundCondition(lowerBound, upperBound, comparator);
    }
