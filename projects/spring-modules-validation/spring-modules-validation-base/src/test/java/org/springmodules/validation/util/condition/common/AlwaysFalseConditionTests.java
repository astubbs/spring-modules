...
/**
 * Tests for {@link AlwaysFalseCondition}.
 *
 * @author Uri Boness
 */
public class AlwaysFalseConditionTests extends TestCase {

    private AlwaysFalseCondition condition;
    ...
    public void testCheck_WithNull() throws Exception {
        assertFalse(condition.check(null));
    }
