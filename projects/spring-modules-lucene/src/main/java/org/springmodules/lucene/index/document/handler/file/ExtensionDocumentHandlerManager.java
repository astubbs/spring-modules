 ...
 * 
 * It only adds the text document handler as default handlers.
 * 
 * @author Thierry Templier
 * @see org.springmodules.lucene.index.support.handler.file.ExtensionDocumentMatching
 * @see TextDocumentHandler
 */
