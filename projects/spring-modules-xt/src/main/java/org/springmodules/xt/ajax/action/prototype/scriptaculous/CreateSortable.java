...
/**
 * Ajax action for creating a new Scriptaculous sortable container element (see http://wiki.script.aculo.us/scriptaculous/show/Sortable.create).<br>
...
public class CreateSortable extends AbstractExecuteJavascriptAction {
    ...
    /**
     * Construct a Scriptaculous action for creating a sortable container element.<br>
     *
     * @param elementId The id of the element.
     */
    public CreateSortable(String elementId) {
    ...
    protected String getJavascript() {
        StringBuilder effect = new StringBuilder("Sortable.create");
