...
public class JcrNamespaceHandlerTests extends TestCase {
	...
	private Object getPropertyValue(final RootBeanDefinition beanDefinition, final String propertyName) {
	...
	public void testEventListenerDefinition() throws Exception {
		...
		assertTrue(ObjectUtils.nullSafeEquals(new String[] { "foo", "bar" }, getPropertyValue(beanDefinition,
				"nodeTypeName")));
	}
