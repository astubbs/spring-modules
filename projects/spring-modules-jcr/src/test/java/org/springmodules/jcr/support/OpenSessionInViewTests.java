...
public class OpenSessionInViewTests extends TestCase {
	...
	public void testOpenSessionInViewFilter() throws Exception {
		...
		final MockControl sf2Control = MockControl.createControl(SessionFactory.class);
		...
		final MockFilterConfig filterConfig = new MockFilterConfig(wac.getServletContext(), "filter");
		final MockFilterConfig filterConfig2 = new MockFilterConfig(wac.getServletContext(), "filter2");
		filterConfig2.addInitParameter("sessionFactoryBeanName", "mySessionFactory");

		final MockFilterConfig filterConfig3 = new MockFilterConfig(wac.getServletContext(), "filter3");
		...
		final FilterChain filterChain4 = new FilterChain() {
			public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse)
					throws IOException, ServletException {
