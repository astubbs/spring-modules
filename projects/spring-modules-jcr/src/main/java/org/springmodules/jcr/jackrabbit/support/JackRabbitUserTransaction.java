...
public class JackRabbitUserTransaction implements UserTransaction {
	 ...
	 * 
	 * @param session
	 *            session. If session is not of type {@link XASession}, an <code>IllegalArgumentException</code> is
	 *            thrown
	 */
	public JackRabbitUserTransaction(final Session session) {
	...
	class XidImpl implements Xid {
		 ...
		 */
		public XidImpl(final byte globalTxNumber) {
