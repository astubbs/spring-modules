...
/**
 * JackRabbit specific session holder. This holder should be used with OpenSessionInViewFilter/Interceptor or
 * JcrInterceptor with JackRabbit if transactional support is required. The default session holder however it is
