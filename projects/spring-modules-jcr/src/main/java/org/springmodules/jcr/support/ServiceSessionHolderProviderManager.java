...
/**
 * Implementation of SessionHolderProviderManager which does dynamic discovery of the providers using the JDK 1.3+ <a
 * href="http://java.sun.com/j2se/1.3/docs/guide/jar/jar.html#Service%20Provider"> 'Service Provider' specification</a>.
 * 
 * The class will look for org.springmodules.jcr.SessionHolderProvider property files in META-INF/services directories.
 * 
 * @author Costin Leau
 * 
 */
public class ServiceSessionHolderProviderManager extends CacheableSessionHolderProviderManager {
	...
	public List getProviders() {
		final Iterator i = Service.providers(SessionHolderProvider.class, Thread.currentThread()
