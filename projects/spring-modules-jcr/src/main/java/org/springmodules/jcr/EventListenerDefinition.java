...
/**
 * Transport class used for registering event types inside a workspace. It contains defaults for all properties except
...
public class EventListenerDefinition implements InitializingBean {
	 ...
	 */
	public void setEventTypes(final int eventTypes) {
	 ...
	 *            The isDeep to set.
	 */
	public void setDeep(final boolean isDeep) {
		this.isDeep = isDeep;
	}
