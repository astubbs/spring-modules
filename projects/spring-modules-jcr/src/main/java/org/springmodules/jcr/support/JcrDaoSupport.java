...
public abstract class JcrDaoSupport extends DaoSupport {
	 ...
	 */
	public final void setTemplate(final JcrTemplate jcrTemplate) {
	 ...
	 * @see org.springmodules.jcr.SessionFactoryUtils#getSession
	 */
	protected final Session getSession(final boolean allowCreate) throws DataAccessResourceFailureException,
	 ...
	 */
	protected final DataAccessException convertJcrAccessException(final RepositoryException ex) {
