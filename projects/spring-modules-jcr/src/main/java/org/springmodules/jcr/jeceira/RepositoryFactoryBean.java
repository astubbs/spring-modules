...
/**
 * FactoryBean for creating a Jeceira (JCR-170) repository through Spring configuration files.
 * 
 * @author Costin Leau
 * 
 */
public class RepositoryFactoryBean extends org.springmodules.jcr.RepositoryFactoryBean {
	...
	/**
	 * Used if the user wants to supply his own configuration manager (configuration created dynamically).
	 */
	...
	protected Repository createRepository() throws Exception {
		final RepositoryFactory factory = RepositoryFactory.getInstance(configManager);
