 ...
 * @author Sergio Bossa
 */
public class EnhancedSimpleFormControllerTest extends AbstractDependencyInjectionSpringContextTests {
    
    public EnhancedSimpleFormControllerTest(String testName) {
        super(testName);
    }
