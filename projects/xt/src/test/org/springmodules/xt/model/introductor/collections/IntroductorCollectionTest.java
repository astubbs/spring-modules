 ...
 * @author Sergio Bossa
 */
public class IntroductorCollectionTest extends TestCase {
    
    private Collection target;
    
    public IntroductorCollectionTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(IntroductorCollectionTest.class);
    ...
    public void testModifyAndIteratePartOne() {
        IntroductorCollection introductor = new IntroductorCollection(target, new Class[]{EmployeeView.class}, new DynamicBeanIntroductor());
