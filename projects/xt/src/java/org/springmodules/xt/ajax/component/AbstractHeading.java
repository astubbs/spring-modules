 ...
 * @author Sergio Bossa
 */
public abstract class AbstractHeading extends SimpleHTMLComponent {
    
    /**
     * Construct an empty heading.
     */
    public AbstractHeading() {
    }
	...
	protected String getTagName() {
		return new StringBuilder("h").append(Integer.toString(getLevel())).toString();
	}
