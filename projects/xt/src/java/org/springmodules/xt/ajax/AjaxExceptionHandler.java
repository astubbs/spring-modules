 ...
 * mapping an exception class with an {@link AjaxExceptionResolver}
 * that will be used to resolve the exception in a response delivered to clients
...
public class AjaxExceptionHandler implements ApplicationContextAware, HandlerExceptionResolver, Ordered {
    ...
    /**
     * Associate the best {@link AjaxExceptionResolver} to the given exception.<br>
     * The association is done using the actual exception class: if an {@link AjaxExceptionResolver}
     * is mapped for both the actual exception class and one of its superclasses,
     * the resolver configured for the actual exception class will be used.<br><br>
     * Once an {@link AjaxExceptionResolver} is found, its ajax response is sent to the client and
     * a cleared ModelAndView object is returned.<br><br>
     * If no {@link AjaxExceptionResolver} is found, a null ModelAndView object is returned
     * and other HandlerExceptionResolvers will be processed.<br><br>
     * Please note that the exception is resolved only if the current request is an Ajax one; otherwise,
     * other HandlerExceptionResolvers will be processed.
     *
    ...
    /**
     * {@link AjaxExceptionResolver} actual lookup.
     *
