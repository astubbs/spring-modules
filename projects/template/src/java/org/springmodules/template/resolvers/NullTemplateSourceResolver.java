...
/**
 * An "empty" implementation of the TemplateSourceResolver that always return
 * <code>null</code>.
 *
 * @author Uri Boness
 */
public class NullTemplateSourceResolver implements TemplateSourceResolver {
    ...
    public final static TemplateSourceResolver INSTANCE = new NullTemplateSourceResolver();
