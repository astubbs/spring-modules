...
/**
 * A velocity engine that uses ExtendedRuntimeInstance.
 * This class is 95% copy of VelocityEngine class only instead of using
 * RuntimeInstance, ExtendedRuntimeInstance is used.
 *
 * @author <a href="mailto:geirm@optonline.net">Geir Magnusson Jr.</a> (original author)
 * @author Uri Boness
 */
public class ExtendedVelocityEngine implements RuntimeConstants {
    ...
    public ExtendedVelocityEngine() {
        ri = new ExtendedRuntimeInstance();
    }

    public ExtendedVelocityEngine(ExtendedRuntimeInstance ri) {
        this.ri = ri;
    }
     ...
     */
    public boolean evaluate(Context context, Writer out, String logTag, String instring) throws
        ParseErrorException,
