...
/**
 * A FactoryBean that creates {@link org.springmodules.template.providers.velocity.VelocityTemplateSet}s.
 *
 * @author Uri Boness
 */
public class VelocityTemplateSetFactoryBean extends AbstractTemplateSetFactoryBean {
     ...
     */
    public VelocityTemplateSetFactoryBean() {
    }
    ...
    /**
     * Creats a new {@link org.springmodules.template.providers.velocity.VelocityTemplateFactory}.
     *
