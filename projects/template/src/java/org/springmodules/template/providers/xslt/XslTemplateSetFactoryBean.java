...
/**
 * A BeanFactory that creates {@link org.springmodules.template.providers.xslt.DomXsltTemplateSet}s.
 *
 * @author Uri Boness
 */
public class XslTemplateSetFactoryBean extends AbstractTemplateSetFactoryBean {
     ...
     */
    public XslTemplateSetFactoryBean() {
     ...
     * @see org.springmodules.template.providers.xslt.DomXsltTemplateFactory#setModelToDomConverterByName(java.util.Map)
     */
