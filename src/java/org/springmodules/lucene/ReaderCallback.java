...
{
    /**
     * An open IndexReader will be passed in, and should be managed by the LuceneTemplate. In other words,
     * let the framework close it for you, please.
     *
     * @param reader an open IndexReader
     * @return value to be returned by the LuceneTemplate#withReader
