...
/**
 * <p>
 * Unit Tests for <code>{@link OsCacheModel}</code>.
 * </p>
 * 
 * @author Alex Ruiz
 * 
 ...
 */
public final class OsCacheModelTests extends TestCase implements
    EqualsHashCodeTestCase {

  private static Log logger = LogFactory.getLog(OsCacheModelTests.class);

  private OsCacheModel cacheModel;

  public OsCacheModelTests(String name) {
    super(name);
  }
  ...
  public void testEqualsHashCodeRelationship() {
    ...
    OsCacheModel anotherModel = new OsCacheModel(groups, refreshPeriod,
        cronExpression);
  ...
  public void testEqualsIsTransitive() {
    ...
    OsCacheModel secondModel = new OsCacheModel(groups, refreshPeriod);
    OsCacheModel thirdModel = new OsCacheModel(groups, refreshPeriod);
