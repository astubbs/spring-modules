...
/**
 * <p>
 * Unit Test for <code>{@link EhcacheCacheProfileEditor}</code>.
 * </p>
 * 
 * @author Alex Ruiz
 * 
 ...
 */
public final class EhcacheCacheProfileEditorTests extends TestCase {

  /**
   * Primary object (instance of the class to test).
   */
  private EhcacheCacheProfileEditor factory;
   ...
   */
  public EhcacheCacheProfileEditorTests(String name) {
    super(name);
  }
  ...
  protected void setUp() throws Exception {
    super.setUp();
    this.factory = new EhcacheCacheProfileEditor();
  }

  /**
   * Verifies that the method
   * <code>{@link EhcacheCacheProfileEditor#createCacheProfile(Properties)}</code>
   ...
   * Verifies that the method
   * <code>{@link EhcacheCacheProfileEditor#createCacheProfile(Properties)}</code>
   * creates a new instance of <code>{@link EhcacheCacheProfile}</code>
  ...
  public void testCreateCacheProfileWithNotEmptyGroup() {
    ...
    EhcacheCacheProfile expectedProfile = new EhcacheCacheProfile();
