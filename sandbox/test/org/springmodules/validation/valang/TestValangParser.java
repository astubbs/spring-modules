...
public class TestValangParser extends TestCase {
	...
	public void testParser13InRule() {
		String text =
			"{size : upper(size) in upper(lower('S')), upper(upper(lower(lower('M')))), upper('L'), 'XL' : 'Not a valid size.'}"
		;
