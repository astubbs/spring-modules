...
/**
 * <p>
 * Unit Tests for <code>{@link ShortHandler}</code>.
 * </p>
 * 
 * @author Alex Ruiz
 * 
 ...
 */
public final class ShortHandlerTests extends
    AbstractApacheXmlRpcTypeHandlerTestCase {

  /**
   * Object to be handled by <code>{@link #typeHandler}</code>
   */
  private Short objectToHandle;

  /**
   * Primary object that is under test.
   */
  private ShortHandler typeHandler;
   ...
   */
  public ShortHandlerTests(String name) {
    super(name);
  }
  ...
  protected Object getExpectedHandledObject() {
    return new Integer(this.objectToHandle.intValue());
  }
  ...
  protected void onSetUp() throws Exception {
    ...
    this.objectToHandle = new Short((short) 88);
    this.typeHandler = new ShortHandler();
  }
