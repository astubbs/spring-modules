...
/**
 * <p>
 * Unit Tests for <code>{@link CharacterHandler}</code>.
 * </p>
 * 
 * @author Alex Ruiz
 * 
 ...
 */
public final class CharacterHandlerTests extends
    AbstractApacheXmlRpcTypeHandlerTestCase {

  /**
   * Object to be handled by <code>{@link #typeHandler}</code>
   */
  private Character objectToHandle;

  /**
   * Primary object that is under test.
   */
  private CharacterHandler typeHandler;
   ...
   */
  public CharacterHandlerTests(String name) {
    super(name);
  }
  ...
  protected void onSetUp() throws Exception {
    ...
    this.objectToHandle = new Character('b');
    this.typeHandler = new CharacterHandler();
  }
