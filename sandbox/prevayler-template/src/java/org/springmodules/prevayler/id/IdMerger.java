 ...
 * It works by traversing the whole source object graph, copying into the destination one the identifiers of all objects whose class is a <i>prevalent class</i> in
...
public interface IdMerger extends Serializable {
    ...
    /**
     * Merge the identifiers between the two objects.
     * 
