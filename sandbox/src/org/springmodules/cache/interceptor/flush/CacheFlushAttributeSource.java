...
/**
 * <p>
 * Interface used by <code>{@link CacheFlushInterceptor}</code> to retrieve
 ...
 * @author Alex Ruiz
 * 
 * @version $Revision: 1.1 $ $Date: 2005/04/12 08:37:43 $
 */
public interface CacheFlushAttributeSource {
   ...
   */
  FlushCache getCacheFlushAttribute(Method method, Class targetClass);
}