...
public class ValangParser implements ValangParserConstants {
    ...
    case NOT_IN:
      ...
      default:
        ...
        if (jj_2_3(2)) {
          ...
          jj_consume_token(42);
          jj_consume_token(PATH);
                                          path = token.image; beginLine = token.beginLine; beginColumn = token.beginColumn;
          jj_consume_token(39);
          tmpFunction = function(fieldFunction);
          jj_consume_token(40);
                                          collectionProperty = true; collectionFunction = new MapEntryFunction(new BeanPropertyFunction(path), tmpFunction, beginLine, beginColumn);
        } else {
          jj_consume_token(-1);
          throw new ParseException();
        }
  ...
  static {
   ...
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x10,0x10,0x8,0x0,0x0,0x1c84,0x1c04,0x0,0x0,0x1c04,0x0,0x804,0x1404,0x404,0x0,};
   }
