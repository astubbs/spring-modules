 ...
 * @author Sergio Bossa
 */
public class IntroductorCollection extends AbstractCollection {
    ...
    /**
     * Construct the decorated introductor collection, starting from a target collection which will not be modified.
     * 
     * @param target The collection to decorate, whose objects must be introduced.
     * @param introducedInterfaces The interfaces to introduce.
     * @param targetObjectsInterfaces The interfaces of the objects into the collection.
    ...
    private class IntroductorIterator implements Iterator {
        ...
        public Object next() {
            ...
            Object cachedObject = IntroductorCollection.this.cachedValues.get(this.currentSourceObject);
            ...
            // If there's no cached object, make a new introduction:
                ...
                Object result = IntroductorCollection.this.introduce(this.currentSourceObject);
                IntroductorCollection.this.cachedValues.put(this.currentSourceObject, result);
                return result;
            }
        }
        ...
        public void remove() {
            ...
            IntroductorCollection.this.cachedValues.remove(this.currentSourceObject);
        }
    }
}
