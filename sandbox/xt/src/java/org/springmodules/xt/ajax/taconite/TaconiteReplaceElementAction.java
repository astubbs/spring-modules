 ...
 * @author Sergio Bossa
 */
public class TaconiteReplaceElementAction extends AbstractTaconiteRenderingAction {
     ...
     */
    public TaconiteReplaceElementAction(String elementId, List<Component> components) {
     ...
     */
    public TaconiteReplaceElementAction(String elementId, Component component) {
