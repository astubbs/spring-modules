 ...
 * logical operation of the instantCondition. It is highly recommended for instantCondition implementation to
...
public abstract class AbstractCondition implements Condition {
    ...
    /**
     * Performs the actual checking of this instantCondition on the checked object.
     *
     * @param object The object to be checked.
     * @return <code>true</code> if the given object adheres to this instantCondition, <code>false</code> otherwise.
     */
     ...
     * can override this method and change the checkCalendar result. By default, this method returns the original checkCalendar result.
     *
     * @param object The checked object.
     * @param originalResult The original checkCalendar result as returned by the specific instantCondition implementation.
     * @return The final checkCalendar result.
     */
