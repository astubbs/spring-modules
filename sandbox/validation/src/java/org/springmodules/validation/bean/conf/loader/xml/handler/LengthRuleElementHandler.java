...
public class LengthRuleElementHandler extends AbstractPropertyValidationElementHandler {
     ...
     */
    public static final String DEFAULT_LENGTH_ERROR_CODE = LENGTH_ERROR_CODE;

    /**
     * The default error code for a min length validation rule.
     */
    public static final String DEFAULT_MIN_LENGTH_ERROR_CODE = MIN_LENGTH_ERROR_CODE;

    /**
     * The default error code for a max length validation rule.
     */
    public static final String DEFAULT_MAX_LENGTH_ERROR_CODE = MAX_LENGTH_ERROR_CODE;
