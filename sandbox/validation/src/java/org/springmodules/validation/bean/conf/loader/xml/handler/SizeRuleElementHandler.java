...
public class SizeRuleElementHandler extends AbstractPropertyValidationElementHandler {
     ...
     */
    public static final String DEFAULT_SIZE_RANGE_ERROR_CODE = SIZE_ERROR_CODE;

    /**
     * The default error code for the created minimum size validation rule.
     */
    public static final String DEFAULT_MIN_SIZE_ERROR_CODE = MIN_SIZE_ERROR_CODE;

    /**
     * The default error code for the created maximum size validation rule.
     */
    public static final String DEFAULT_MAX_SIZE_ERROR_CODE = MAX_SIZE_ERROR_CODE;
