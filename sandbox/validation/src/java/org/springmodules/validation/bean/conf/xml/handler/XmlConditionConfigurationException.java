...
/**
 * An {@link XmlConditionConfigurationException} that is thrown by the {@link AbstractValidationRuleElementHandler#extractCondition(org.w3c.dom.Element)}
 * method if the xml configuration for a validation rule condition is wrong.
 *
 * @author Uri Boness
 */
