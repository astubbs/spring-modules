...
/**
 * A composite {@link org.springmodules.validation.bean.conf.BeanValidationConfigurationLoader} implementation that loads bean validation configuration
 * using multiple sub-loaders.
 *
 * @author Uri Boness
 */
