 ...
 * @author Uri Boness
 */
public class PropertyValidatoinRule implements ValidationRule {
    ...
    /**
     * Constructs a new PropertyValidatoinRule (javabean support).
     */
    public PropertyValidatoinRule() {
    }

    /**
     * Constructs a new PropertyValidatoinRule with a given property and a wrapped validation rule.
     *
     * @param propertyName The name of the associated property.
     * @param rule The validation rule to be wrapped.
     */
    public PropertyValidatoinRule(String propertyName, ValidationRule rule) {
