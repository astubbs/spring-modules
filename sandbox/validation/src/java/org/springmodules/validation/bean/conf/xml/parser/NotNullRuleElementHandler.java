...
/**
 * An {@link AbstractValidationRuleElementHandler} implementation that can handle an element that represents a not-null
 * validation rule.
 *
 * @author Uri Boness
 */
public class NotNullRuleElementHandler extends AbstractValidationRuleElementHandler
