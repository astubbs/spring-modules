 ...
 * @author Uri Boness
 */
public class InstantInPastRuleElementHandler extends AbstractValidationRuleElementHandler
     ...
     */
    public InstantInPastRuleElementHandler() {
        super(InstantInPastRuleElementHandler.ELEMENT_NAME, DEFAULT_NAMESPACE_URL);
    }
    ...
    protected String getDefaultErrorCode(Element element) {
        return InstantInPastRuleElementHandler.DEFAULT_ERROR_CODE;
    }
