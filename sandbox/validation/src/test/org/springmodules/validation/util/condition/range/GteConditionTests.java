...
/**
 * Tests for {@link GteCondition}.
 *
 * @author Uri Boness
 */
public class GteConditionTests extends AbstractSingleBoundConditionTests {

    protected AbstractSingleBoundCondition createCondition(Comparable bound) {
        return new GteCondition(bound);
    }

    protected AbstractSingleBoundCondition createCondition(Object bound, Comparator comparator) {
        return new GteCondition(bound, comparator);
    }
