...
/**
 * Tests for {@link SomeCollectionCondition}.
 *
 * @author Uri Boness
 */
public class SomeCollectionConditionTests extends AbstractCollectionElementConditionTests {

    protected AbstractCollectionCondition createCondition() {
        return new SomeCollectionCondition(new AbstractCondition() {
    ...
    public void testConstructor_WithNullElementCondition() throws Exception {
        try {
            new SomeCollectionCondition(null);
