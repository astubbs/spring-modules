 ...
 * Can be applied to instances with logical support of the <code>length</code> property
 * (e.g. String, CharSequence, etc...). This has the same meaning as
 * {@link @MinLength(0)}.
 *
 * @author Uri Boness
 */
...
public @interface NotBlank {
     ...
     */
    String errorCode() default NotBlankRuleElementHandler.DEFAULT_ERROR_CODE;

    /**
     * Returns the default message that represents the error when the validation fails.
     */
    String message() default NotBlankRuleElementHandler.DEFAULT_ERROR_CODE;
