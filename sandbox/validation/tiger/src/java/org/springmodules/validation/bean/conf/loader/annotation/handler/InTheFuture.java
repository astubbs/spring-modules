...
public @interface InTheFuture {
     ...
     */
    String errorCode() default DefaultValidationErrorCodes.DATE_IN_FUTURE_ERROR_CODE;

    /**
     * Returns the default message that represents the error when the validation fails.
     */
    String message() default DefaultValidationErrorCodes.DATE_IN_FUTURE_ERROR_CODE;
