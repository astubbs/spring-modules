...
public @interface Size {
     ...
     */
    String errorCode() default SizeRuleElementHandler.DEFAULT_SIZE_RANGE_ERROR_CODE;

    /**
     * Returns the default message that represents the error when the validation fails.
     */
    String message() default SizeRuleElementHandler.DEFAULT_SIZE_RANGE_ERROR_CODE;
