 ...
 * can be applied to CharSequence's.
 *
 * @author Uri Boness
 */
@Documented
...
public @interface RegExp {
     ...
     */
    String errorCode() default RegExpRuleElementHandler.DEFAULT_ERROR_CODE;

    /**
     * Returns the default message that represents the error when the validation fails.
     */
    String message() default RegExpRuleElementHandler.DEFAULT_ERROR_CODE;
